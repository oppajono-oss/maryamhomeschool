...
const firebaseConfig = {
    "projectId": "studybuddy-homeschool",
    "appId": "1:34728672705:web:d1e876cfd0031cba448340",
    "storageBucket": "studybuddy-homeschool.appspot.com",
    "apiKey": "AIzaSyAXAZ1aX8HD7FR2ql2fqeHXgBgSq_btErk",
    "authDomain": "studybuddy-homeschool.firebaseapp.com",
    "measurementId": "",
    "messagingSenderId": "34728672705"
};
// Initialize Firebase
...
// Enable offline persistence to speed up reads after first load
if ("TURBOPACK compile-time truthy", 1) {
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["enableIndexedDbPersistence"])(db).catch(()=>{
    // Ignore persistence errors (e.g., private mode or multiple tabs)
    });
}
const uploadPhoto = async (userId, file)=>{
    const filePath = `users/${userId}/gallery/${Date.now()}-${file.name}`;
...
"[project]/src/hooks/use-firestore-data.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname, k: __turbopack_refresh__, m: module } = __turbopack_context__;
{
__turbopack_context__.s({
    "useFirestoreData": (()=>useFirestoreData)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
...
function useFirestoreData() {
    _s();
    const [data, setDataState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [user, setUser] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    // Effect for handling authentication
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useFirestoreData.useEffect": ()=>{
            const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm2017$2f$index$2d$35c79a8a$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__z__as__onAuthStateChanged$3e$__["onAuthStateChanged"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["auth"], {
                "useFirestoreData.useEffect.unsubscribe": async (currentUser)=>{
                    if (currentUser) {
                        setUser(currentUser);
                    } else {
                        // No user, sign in anonymously. The listener will catch the new user state.
                        try {
            ...
            }["useFirestoreData.useEffect.unsubscribe"]);
            return ({
                "useFirestoreData.useEffect": ()=>unsubscribe()
            })["useFirestoreData.useEffect"];
        }
    }["useFirestoreData.useEffect"], []); // Runs only once on mount
    // Effect for fetching/creating data once the user is available
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useFirestoreData.useEffect": ()=>{
            if (!user) {
            ...
            // Hydrate from localStorage immediately for faster paint
            const localKey = `appData:${user.uid}`;
            try {
                const cached = ("TURBOPACK compile-time truthy", 1) ? window.localStorage.getItem(localKey) : ("TURBOPACK unreachable", undefined);
                if (cached) {
            ...
            const fetchData = {
                "useFirestoreData.useEffect.fetchData": async ()=>{
                    ...
                    try {
                        ...
                        if (docSnap.exists()) {
                            ...
                            const lastLogin = new Date(firestoreData.lastLoginDate);
                            // Update streak logic
                            if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$isSameDay$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isSameDay"])(today, lastLogin)) {
                                const yesterday = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$subDays$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["subDays"])(today, 1);
                                const newStreak = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$isSameDay$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isSameDay"])(yesterday, lastLogin) ? (firestoreData.streak || 0) + 1 : 1;
                                const updatedData = {
                                    ...firestoreData,
                                    streak: newStreak,
                                    lastLoginDate: today.toISOString()
                                };
                                // Update db without waiting for it to complete for faster UI response
                                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setDoc"])(docRef, updatedData, {
                                    merge: true
                                });
                                ...
                                try {
                                    window.localStorage.setItem(localKey, JSON.stringify(firestoreData));
                                } catch  {}
                            }
                        } else {
                            ...
                            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setDoc"])(docRef, newUserData);
                            setDataState(newUserData);
                            try {
                                window.localStorage.setItem(localKey, JSON.stringify(newUserData));
                            } catch  {}
                        }
                    } catch (error) {
                        console.error("Error fetching or creating user data:", error);
                        // Set initial data locally on error to allow app to function
                        setDataState(initialData);
                        try {
                            window.localStorage.setItem(localKey, JSON.stringify(initialData));
                        } catch  {}
                    } finally{
                        setLoading(false);
                    }
                }
            }["useFirestoreData.useEffect.fetchData"];
            fetchData();
        }
    }["useFirestoreData.useEffect"], [
        user
    ...
    const setData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useFirestoreData.useCallback[setData]": (updater)=>{
            if (!user) {
                console.error("Cannot set data: no user is authenticated.");
                return;
            }
            setDataState({
                "useFirestoreData.useCallback[setData]": (prevData)=>{
                    const newData = updater(prevData);
                    if (newData) {
                        const docRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], "users", user.uid);
                        // Use { merge: true } to only update fields that have changed.
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setDoc"])(docRef, newData, {
                            merge: true
                        }).catch({
                            "useFirestoreData.useCallback[setData]": (error)=>{
                                console.error("Error writing to Firestore:", error);
                            }
                        }["useFirestoreData.useCallback[setData]"]);
                        // Update cache for snappy subsequent renders
                        try {
                            window.localStorage.setItem(`appData:${user.uid}`, JSON.stringify(newData));
                        } catch  {}
                    }
                    return newData;
                }
        ...
        user
    ] // Dependency on user ensures the correct UID is used
    );
    return {
        data,
        setData,
...
_s(useFirestoreData, "dSoJfPxLxPO6a6fgiLzQiswGmeQ=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
"[project]/src/context/data-provider.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$firestore$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/hooks/use-firestore-data.ts [app-client] (ecmascript)");
;
...
function DataProvider({ children }) {
    _s();
    const firestoreData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$firestore$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFirestoreData"])();
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(DataContext.Provider, {
        ...
        fileName: "[project]/src/context/data-provider.tsx",
        lineNumber: 26,
        columnNumber: 9
    }, this);
}
_s(DataProvider, "BfV6slq68tBJ5gMU82+ZGTdgu1I=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$firestore$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFirestoreData"]
    ];
});
_c = DataProvider;
function useData() {
...
//# sourceMappingURL=src_2f3d2e74._.js.map